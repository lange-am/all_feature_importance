...
from ..tree._tree import MAX_INT32 as MAX_INT # === RIT ===
...
def _accumulate_prediction(predict, X, out, lock):
    ...
    It can't go locally in ForestClassifier or ForestRegressor, 
    because joblib complains that it cannot pickle it when placed there.
    """
...
# === RIT === begin
    rit_alpha : double, default=None
        Redundancy Insensitive Tree (RIT) alpha.
        ...
        If -np.inf or None then an ensemble of classical decision trees is built, 
        i.e. the best feature is selected only among those sampled according to 
        ``max_features``.

    subforest_importance : bool, default=False
        If True then the importance of a feature is normalized by the number 
        of trees containing that feature, otherwise by the total number of trees 
...
# === RIT === end
    ...
    def __init__(
        ...
        *,
        ...
        self.subforest_importance = subforest_importance
