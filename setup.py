...
#               2023 Andrey Lange <lange_am@mail.ru> 
...
DISTNAME = "rit"
DESCRIPTION = "Redundancy-insensitive feature importance in ensembles of decision trees"
with open("README.rst") as f:
    LONG_DESCRIPTION = f.read()
MAINTAINER = "Andrey Lange"
MAINTAINER_EMAIL = "lange_am@mail.ru"
URL = ""
DOWNLOAD_URL = ""
LICENSE = "new BSD"
PROJECT_URLS = {}
...
class CleanCommand(Command):
    ...
    def run(self):
        ...
        if os.path.exists("build"):
            shutil.rmtree("build")
        for dirpath, dirnames, filenames in os.walk("rit"):
...
class build_ext_subclass(build_ext):
    ...
    def build_extensions(self):
        from sklearn import _OPENMP_SUPPORTED
...
extension_config = {
    "tree": [
        ...
        {"sources": ["_splitter.pyx"], "include_np": True, "optimization_level": "O3", "language": "c++"},
        {"sources": ["_criterion.pyx"], "include_np": True, "optimization_level": "O3", "language": "c++"},
        {"sources": ["_utils.pyx"], "include_np": True, "optimization_level": "O3", "language": "c++"},
    ],
}
...
def configure_extension_modules():
    ...
    for submodule, extensions in extension_config.items():
        ...
        parent_dir = join("rit", *submodule_parts)
        for extension in extensions:
            ...
            if submodule:
                name_parts = ["rit", submodule, source_name]
            else:
                name_parts = ["rit", source_name]
...
def setup_package():
    ...
    metadata = dict(
        ...
        install_requires=min_deps.tag_to_packages["install"] + 
                             ...
                             ["cython=="+min_deps.CYTHON_MIN_VERSION+",<3.0"], 
        package_data={"": ["*.pxd", "*.rst"]},
    ...
    if not all(
        ...
        if sys.version_info < required_python_version:
            ...
            raise RuntimeError(
                "RIT requires Python %s or later. The current"
